...
Log.setLogLog = () => {Log.level = LEVELS.LOG };

Log.setLogWarn = () => {Log.level = LEVELS.WARN };
Log.setLogError = () => {Log.level = LEVELS.ERROR };
Log.setLogFatal = () => {Log.level = LEVELS.FATAL };
Log.setLogOff = () => {Log.level = Number.MAX_VALUE };
